...
export const alphabet = [
  ...
  { letter: 'ක', romanized: 'ka', type: 'consonant', audio: 'Like "k" in "kite"' },
  { letter: 'ග', romanized: 'ga', type: 'consonant', audio: 'Like "g" in "go"' },
  { letter: 'ච', romanized: 'cha', type: 'consonant', audio: 'Like "ch" in "church"' },
  { letter: 'ජ', romanized: 'ja', type: 'consonant', audio: 'Like "j" in "jump"' },
  ...
  { letter: 'ත', romanized: 'tha', type: 'consonant', audio: 'Dental "th" — tongue touches teeth' },
  { letter: 'ද', romanized: 'da', type: 'consonant', audio: 'Dental "d" — tongue touches teeth' },
  { letter: 'ප', romanized: 'pa', type: 'consonant', audio: 'Like "p" in "pen"' },
  { letter: 'බ', romanized: 'ba', type: 'consonant', audio: 'Like "b" in "bat"' },
  { letter: 'ම', romanized: 'ma', type: 'consonant', audio: 'Like "m" in "mother"' },
  { letter: 'ය', romanized: 'ya', type: 'consonant', audio: 'Like "y" in "yes"' },
  { letter: 'ර', romanized: 'ra', type: 'consonant', audio: 'Rolled "r" like in Spanish' },
  { letter: 'ල', romanized: 'la', type: 'consonant', audio: 'Like "l" in "love"' },
  { letter: 'ව', romanized: 'va', type: 'consonant', audio: 'Like "v" in "very"' },
  { letter: 'ස', romanized: 'sa', type: 'consonant', audio: 'Like "s" in "sun"' },
  { letter: 'හ', romanized: 'ha', type: 'consonant', audio: 'Like "h" in "hat"' },
  { letter: 'න', romanized: 'na', type: 'consonant', audio: 'Dental "n" — tongue touches teeth' },
  { letter: 'ණ', romanized: 'ṇa', type: 'consonant', audio: 'Retroflex "n" — tongue curled back' },
  { letter: 'ළ', romanized: 'ḷa', type: 'consonant', audio: 'Retroflex "l" — tongue curled back' },
  { letter: 'ෆ', romanized: 'fa', type: 'consonant', audio: 'Like "f" in "fun"' },
];
